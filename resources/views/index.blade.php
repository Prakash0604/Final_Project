...
<div class="form signup">
  ...
  <form action="{{ url('/register') }}" method="POST">
    @csrf
    <input type="text" placeholder="Full name"  name="full_name"  class=" form-control @error('full_name') is-invalid @enderror" />
    @error('full_name')
   ...
   @enderror
    ...
    <span class="text-danger">{{ $message }}</span>
    @enderror
    <input type="text" placeholder="Refer code(Optional)" name="referal_code"  class="form-control"  />
